...
PV_USERS = ['marlonviral','ofcuba','marlonviral']
...
def createUser(name):
    import time
    USERS[name] = {'dir':'','cloudtype':'moodle','moodle_host':'https://aulacened.uci.cu/user/files.php/','moodle_repo_id':4,'moodle_user':'','moodle_password':'','isadmin':0,'zips':100}
